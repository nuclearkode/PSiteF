...
export default function Hero() {
  ...
  return (
    <div id="top" className="hero-wrap relative w-full max-w-[1280px] mx-auto px-gutter mt-top min-h-[clamp(450px,60vh,600px)]">
      <div className="relative w-full h-full min-h-[inherit] bg-card rounded-4xl border-2 border-white/10 shadow-[0_30px_60px_rgba(0,0,0,0.35)] ring-1 ring-inset ring-white/5 overflow-hidden">
        {humanoidImage && (
          <Image
